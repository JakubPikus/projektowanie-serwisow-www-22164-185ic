...
$("#z2").click(function currentTime(){
    ...
    min = updateTime(min);
    sec = updateTime(sec);
    document.getElementById("wynik").innerText = hour + " : " + min + " : " + sec; /* adding time to the div */
    $('#wynik').show();
   ...
   x[0].innerHTML = "W"; // x[0] to pierwszy znaleziony element
   x[1].innerHTML = "i"; // x[0] to pierwszy znaleziony element
   x[2].innerHTML = "t"; // x[0] to pierwszy znaleziony element
   x[3].innerHTML = "a"; // x[0] to pierwszy znaleziony element
   x[4].innerHTML = "m"; // x[0] to pierwszy znaleziony element
});
